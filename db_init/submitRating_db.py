...
def submitRating_db(
    ...
    # Establish connection with database (details found in Heroku dashboard
    # after login)
    ...
    cursor.execute(
        '''INSERT INTO staged_ratings (user_upload_ip, staged_rating_id, asset_id, user_community, generated_timestamp,
