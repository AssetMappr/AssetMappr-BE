...
from constants import COMMUNITIES_MASTER_TABLE, CATEGORIES_MASTER_TABLE, SOURCES_MASTER_TABLE, CATEGORY_FIELD, SOURCE_TYPE_FIELD, COMMUNITY_GEO_ID_FIELD
...
def populateMasterTables(conn):
    ...
    community_master = pd.DataFrame([[4278528,
                                      'Uniontown',
                                      'C5',
                                      '39.8993024',
                                      '-79.7245287'],
